-- Migration 008: generalize the historical-era fail-closed guard for multiple seasons.
-- Migration 007 only guarded season 2010. This version guards any declared
-- historical-data-backed season (currently 2010 and 1995).
